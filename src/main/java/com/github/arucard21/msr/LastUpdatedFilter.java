...
public class LastUpdatedFilter implements Predicate<JsonValue> {

	private Project project;

	public LastUpdatedFilter(Project project) {
		this.project = project;
	}

	@Override
	public boolean test(JsonValue t) {
		LocalDateTime lastUpdated = getDate(t.asJsonObject(), "updated");
		return lastUpdated.isAfter(getStartDate()) && lastUpdated.isBefore(getEndDate());
	}
